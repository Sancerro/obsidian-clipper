...
//	'banner',
	...
	'captcha',
//	'card-text', // too generic — Bootstrap uses this for card body text; isCardGrid catches real card grids
	'card-media',
	'card-post',
//	'carousel',
	'carouselcontainer',
	...
	'comment-area',
	'comment-body',
	'-comment(?![a-z])', // match word-final -comment (top-comment) but not -commentedtext
	'commentbox',
	'comment-button',
	'commentcomp',
	'comment-content',
