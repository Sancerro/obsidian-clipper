...
// Export standalone markdown conversion and math utilities
export { createMarkdownContent, wrapRawLatexDelimiters };
...
(Defuddle as any).wrapRawLatexDelimiters = wrapRawLatexDelimiters;
